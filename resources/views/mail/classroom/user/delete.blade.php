            ...
            <table>
                ...
                <tr>
                    <td class="content">
                        <h2>Xin chào, </h2>
                        <h2><i>(Hello),</i></h2>
                        <p>Bạn vừa rời khỏi lớp {{$className}}. Vì thế bạn không thế truy cập các khóa học liên quan.</p>
                        <p><i>(You have just left the {{$className}} class. So you cannot access related courses any more.)</i></p>
